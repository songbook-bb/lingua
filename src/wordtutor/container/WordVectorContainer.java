...
/**
 * Implements the IWordContainer interface. Has a nested class - WordElem which
 * implements IWord interface nested class can access to the fields of his owner
 * and it uses the maxScore, incScore and decScores fields to work with score of
 * the word The storage uses java.util.vector to keep the words
 * 
 * @author moradan
 */
public class WordVectorContainer implements IWordContainer {
	...
	/**
	 * Nested class implementing IWord interface. Uses the maxScore, incScore
	 * and decScores fields of owner class to work with score of the word
	 */
	class WordElem implements IWord {
		...
		/**
		 * default constructor zeros the foreign and native spelling
		 */
		public WordElem() {
			this.foreignWord = "";
			this.nativeWord = "";
		...
		/**
		 * constructor which creates the word with foreign spelling and native
		 * spelling
		 */
		...
		/**
		 * checks the user's answer for corresponding the right answer its work
		 * depends on the current direction of the translating. If the direction
		 * is straight, this method will compare the answer of user with all
		 * variants of translations of the word. If the direction is reverse,
		 * then it will compare the answer just with the foreign spelling
		 * 
		 * @param answer
		 *            is the user's answer
		 * @param direction
		 *            is a direction of translation - straight or reverse
		 */
	...
	/**
	 * fabric method creating the new Word returns instance of created with
	 * foreignWord foreign spelling and nativeWord native spelling
	 */
